...
knowledge0 = And(
    # A can be either knight or a knave, but not both
...
knowledge1 = And(
    # A can be either knight or a knave, but not both
    And(Or(AKnight,AKnave),Not(And(AKnight,AKnave))),
    # B can be either knight or a knave, but not both
...
knowledge2 = And(
    # A can be either knight or a knave, but not both
    And(Or(AKnight,AKnave),Not(And(AKnight,AKnave))),
    # B can be either knigth or a knave, but not both
    And(Or(BKnight,BKnave),Not(And(BKnight,BKnave))),
    # A Sayings
...
knowledge3 = And(
    ...
    # B can be either knigth or a knave, but not both
    And(Or(BKnight,BKnave),Not(And(BKnight,BKnave))),
    # C can be either knigth or a knave, but not both
